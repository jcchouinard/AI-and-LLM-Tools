...
def main(user_input):
    ...
    action_registry.register(Action(
        ...
        description="Writes content to a file. Use this to save the README.",
        parameters={
            "type": "object",
            "properties": {
                "name": {"type": "string", "description": "The filename (e.g., README.md)"},
...
if __name__ == "__main__":
    main("Write a README for this project and save it to README.md.")